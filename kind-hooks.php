...
{
    echo "<div class='stek-kop-links'><a href='".get_home_url()."' class='radical-riders-title '>Radical Riders</a></div><!--koplinks-->";
}
function ag_logo_in_footer_hook()
{
    echo "<a href='".get_home_url()."' class='radical-riders-title radical-riders-title--footer'>Radical Riders</a>";
}
